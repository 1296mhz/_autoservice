<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Заявка (Opel Zafira Silver)';
...
<img src="images/img0026.png" id="Shape10" alt="" style="border-width:0;width:480px;height:288px;"></div>
...
<span style="color:#228B22;font-family:Tahoma;font-size:27px;">Заявка на Opel Zafira Tourer<br>Sovereign Silver</span></div>
</body>
</html>