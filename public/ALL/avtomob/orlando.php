<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Заявка (Chevrolet Orlando)';
...
<img src="images/img0018.png" id="Shape10" alt="" style="border-width:0;width:480px;height:288px;"></div>
<div id="wb_Text1" style="position:absolute;left:140px;top:42px;width:313px;height:66px;text-align:center;z-index:5;">
<span style="color:#228B22;font-family:Tahoma;font-size:27px;">Заявка на Chevrolet Orlando</span></div>
