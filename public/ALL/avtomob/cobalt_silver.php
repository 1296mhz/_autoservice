<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Заявка (Chevrolet Cobalt Sovereign Silver)';
...
<div id="wb_Text1" style="position:absolute;left:128px;top:29px;width:313px;height:64px;text-align:center;z-index:4;">
<span style="color:#228B22;font-family:Arial;font-size:27px;">Заявка на Chevrolet Cobalt Sovereign Silver</span></div>
<div id="wb_Form1" style="position:absolute;left:116px;top:115px;width:325px;height:172px;z-index:5;">
