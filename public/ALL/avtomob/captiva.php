<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Заявка (Chevrolet Captiva)';
...
<div id="wb_Text1" style="position:absolute;left:96px;top:44px;width:391px;height:33px;text-align:center;z-index:4;">
<span style="color:#228B22;font-family:Tahoma;font-size:27px;">Заявка на Chevrolet Captiva</span></div>
<div id="wb_Form1" style="position:absolute;left:120px;top:110px;width:325px;height:172px;z-index:5;">
