<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Заявка на оценку старого авто';
...
<img src="images/img0009.png" id="Shape10" alt="" style="border-width:0;width:480px;height:288px;"></div>
<div id="wb_Text1" style="position:absolute;left:99px;top:42px;width:378px;height:70px;text-align:center;z-index:5;">
<span style="color:#228B22;font-family:Tahoma;font-size:29px;">Заявка на оценку<br>старого автомобиля</span></div>
