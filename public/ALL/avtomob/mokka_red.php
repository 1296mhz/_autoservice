<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Заявка (Opel Opel Mokka Velvet Red)';
...
<img src="images/img0028.png" id="Shape10" alt="" style="border-width:0;width:480px;height:288px;"></div>
...
<div id="wb_Text1" style="position:absolute;left:105px;top:49px;width:365px;height:66px;text-align:center;z-index:6;">
<span style="color:#228B22;font-family:Tahoma;font-size:27px;">Заявка на Opel Mokka<br>Velvet Red</span></div>
</body>
</html>