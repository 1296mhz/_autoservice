<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Заявка (Chevrolet Spark Sovereign Silver)';
...
<img src="images/img0020.png" id="Shape10" alt="" style="border-width:0;width:480px;height:288px;"></div>
...
<div id="wb_Text1" style="position:absolute;left:135px;top:49px;width:306px;height:66px;text-align:center;z-index:6;">
<span style="color:#228B22;font-family:Tahoma;font-size:27px;">Заявка на Chevrolet Spark Sovereign Silver</span></div>
</body>
</html>