<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Заявка (выгодное предложение)';
...
<img src="images/img0007.png" id="Shape10" alt="" style="border-width:0;width:480px;height:288px;"></div>
<div id="wb_Text1" style="position:absolute;left:126px;top:41px;width:313px;height:42px;z-index:5;text-align:left;">
<span style="color:#228B22;font-family:Arial;font-size:37px;">Отправить заявку</span></div>
<div id="wb_Text2" style="position:absolute;left:164px;top:89px;width:212px;height:36px;text-align:center;z-index:6;">
<span style="color:#000000;font-family:Arial;font-size:16px;"> Введите свои данные и нажмите на кнопку</span></div>
<div id="wb_Form1" style="position:absolute;left:119px;top:133px;width:325px;height:172px;z-index:7;">
