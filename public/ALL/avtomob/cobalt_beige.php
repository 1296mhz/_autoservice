<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Заявка (Chevrolet Cobalt Smokey Beige)';
...
<img src="images/img0013.png" id="Shape10" alt="" style="border-width:0;width:480px;height:288px;"></div>
<div id="wb_Text1" style="position:absolute;left:93px;top:43px;width:397px;height:66px;text-align:center;z-index:5;">
<span style="color:#228B22;font-family:Tahoma;font-size:27px;">Заявка на Chevrolet Cobalt<br>Smokey Beige</span></div>
<div id="wb_Form1" style="position:absolute;left:119px;top:133px;width:325px;height:172px;z-index:6;">
