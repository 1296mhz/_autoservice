<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Заявка (Opel Mokka Boracay Blue)';
...
<img src="images/img0030.png" id="Shape10" alt="" style="border-width:0;width:480px;height:288px;"></div>
...
<div id="wb_Text1" style="position:absolute;left:100px;top:48px;width:365px;height:66px;text-align:center;z-index:6;">
<span style="color:#228B22;font-family:Tahoma;font-size:27px;">Заявка на Opel Mokka Boracay Blue</span></div>
</body>
</html>